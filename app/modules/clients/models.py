"""Modelos ORM usados pelo módulo clients.

Inclui Client, ClientHistory e um Document somente-leitura (necessário para o
endpoint `GET /clients/{id}/documents` enquanto o módulo `documents` não
existe como feature completa).
"""
...
class Document(Base):
    """Modelo somente-leitura para a listagem de documentos do cliente.

    O CRUD completo de documentos pertence ao futuro módulo `documents`.
    """
